...
//  TipsForCityDLUT
//
//  Created by 胡啸晨 on 15/3/27.
//  Copyright (c) 2015年 com.DavidHu. All rights reserved.
//

#ifndef TipsForCityDLUT_NewsAndReportsAPI_h
#define TipsForCityDLUT_NewsAndReportsAPI_h
...
halfcrazy 4月28日
更新成绩查询api,支持查询历史成绩，不保证有效。对term不检验。
...
halfcrazy 5月11日
verify校验用户名密码接口http://1.csxyxzs1.sinaapp.com/verify?name=%s&password=%s
...
halfcrazy 7月6日
个人信息接口，需自行处理字符编码。(暂时不可用)http://2.csxyxzs1.sinaapp.com/verify?name=%s&password=%s
