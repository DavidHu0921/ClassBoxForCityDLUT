...
- (void)viewDidLoad
{
    ...
    [self.collectionView registerNib:headerViewNib forSupplementaryViewOfKind:@"ClassHeaderView" withReuseIdentifier:@"HeaderView"];
...
//        }else
            ...
            headerView.titleLabel.text = [NSString stringWithFormat:@"Day %d", indexPath.item + 1];
        } else if ([kind isEqualToString:@"ClassHeaderView"]) {
